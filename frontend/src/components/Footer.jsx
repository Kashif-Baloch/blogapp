        ...
        <div className="max-w-screen-xl px-4 py-12 mx-auto overflow-hidden sm:px-6 lg:px-8">
          <nav className="flex flex-wrap justify-center">
            <div className="px-5 py-2">
              <a
                href="#"
                className="text-base leading-6 text-gray-500 hover:text-purple-400"
              >
                Home
              </a>
            </div>
          ...
          <div className="flex justify-center mt-8 gap-3 md:gap-6 flex-wrap">
            <a href="#" className="border rounded-full p-1 border-gray-300 text-gray-400 hover:text-gray-500">
